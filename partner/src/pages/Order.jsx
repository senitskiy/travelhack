...
export const Order = () => {
    ...
    const handleClick = () => {
        window.location.replace(`${RUSSPASS_ID_URL}/data_enter?callback=${CALLBACK_URL}&partner=www.partnser.site`)
    }
    ...
    return (
        <div className="bg-indigo-50 h-full ">
            <div className="fixed bottom-0 h-24 bg-white w-full border-t border border-gray-300 flex items-center justify-center">
                ...
                <div onClick={handleClick} className="bg-rp-red px-12 py-4 text-white font-semibold rounded flex justify-center text-center items-center hover:bg-red-600 cursor-pointer">
                    <div className="mr-2">Заполнить c</div>
                    <img src="img/rp_h_logo.svg" alt="" className="w-20" />
                </div>
            </div>
                ...
                <div>
                    ...
                    <div className="customer_form">
                        <div className="flex mb-4">
                            <input type="text" value="Александров" placeholder="Фамилия" className="mr-4 py-3 px-2 flex-1 border border-gray-400 focus:outline-none focus:border-indigo-400 rounded" />
                            <input type="text" value="Александр" placeholder="Имя" className="mr-4 py-3 px-2 flex-1 border border-gray-400 focus:outline-none focus:border-indigo-400 rounded" />
                            <input type="text" value="test@test.ru" placeholder="Электронная почта" className="py-3 px-2 flex-1 border border-gray-400 focus:outline-none focus:border-indigo-400 rounded" />
                        </div>
                        <div className="flex mb-4">
