...
export const PhoneInput = () => {
    ...
    return (
        <Fragment>
            ...
            <Input theme="mb-4" type="text" onChange={handleChange} name="passporNumber" label="Серия и номер паспорта" />
            <Input theme="mb-4" type="text" onChange={handleChange} name="passporDate" label="Дата выдачи" />
            <Input theme="mb-4" type="text" onChange={handleChange} name="passporOrgan" label="Кем выдан" />
            <div className="mt-8">
